...
?>
        ...
        <TABLE BORDER=0 ALIGN=CENTER>
                ...
                <TD><INPUT TYPE="TEXT" NAME="codg_per" onKeyPress="return solo_numeros(this.form.numeexte, event)" class="campo" VALUE="<? echo $codg_per; ?>" SIZE="10" MAXLENGTH="8" title="Ingrese el Número de cédula del personal que desea buscar"></TD>
                </TR>
