...
<FORM METHOD="post" NAME="datos" action="bdc_add_traslados.php">
...
$qry = "INSERT INTO bdc_traslado VALUES ( $codg_per, $codg_plantel_desde,
                         $codg_plantel_hacia, '$fec_egr', '$fec_ing',
                         $codg_cat_cargo, $codg_jer_cargo,
                         $codg_cargo, $codg_tip_traslado, $obser_trasl)";
 mysql_query ($qry);
...
$qry=("UPDATE bdc_datos_lab SET codg_insti=$codg_plantel_hacia,
 ...
 mysql_query($qry);
   ...
   echo '<SCRIPT>alert("Datos Agregados");</SCRIPT>';
                ...
                $consulta_traslados_desde = mysql_query("SELECT t.codg_plantel_desde, t.codg_plantel_hacia, i.nomb_insti FROM bdc_traslado t, bdc_instituciones i WHERE t.codg_per=$codg_per AND
                i.codg_insti=t.codg_plantel_desde");

                 $consulta_traslados_hacia = mysql_query("SELECT t.codg_plantel_desde, t.codg_plantel_hacia, i.nomb_insti FROM bdc_traslado t, bdc_instituciones i WHERE t.codg_per=$codg_per AND
