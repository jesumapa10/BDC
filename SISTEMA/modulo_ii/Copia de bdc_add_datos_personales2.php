...
<FORM METHOD="POST" ENCTYPE="multipart/form-data" NAME="datos" ACTION="">
        <TABLE BORDER="0" ALIGN="CENTER">
                <TR>
                <TD COLSPAN="6">
                <DIV ALIGN="CENTER"><P class="cabecera">Datos Personales</P></DIV>                </TD>
                </TR>

                <TR>
                <TD WIDTH="92"><P ALIGN="RIGHT" class="mini">C&eacute;dula:</P></TD>
                <TD WIDTH="90"><INPUT class="campo" TYPE="TEXT" NAME="codg_per" SIZE="8" MAXLENGTH="8" VALUE="<? echo $codg_per; ?>"></TD>
                <TD WIDTH="105"><P ALIGN="RIGHT" class="mini">Nombre(s):</P></TD>
                <TD WIDTH="150"><INPUT class="campo" TYPE="TEXT" NAME="nomb_per" MAXLENGTH="30" SIZE="30" VALUE="<? echo $nomb_per; ?>"></TD>
                <TD WIDTH="103"><P ALIGN="RIGHT" class="mini">Apellido(s):</P></TD>
                <TD WIDTH="150"><INPUT class="campo" TYPE="TEXT" NAME="apel_per" MAXLENGTH="30" SIZE="30" VALUE="<? echo $apel_per; ?>"></TD>
                </TR>

                <TR>
                <TD><P ALIGN="RIGHT" class="mini">Sexo:</P></TD>
                <TD><SELECT class="campo" NAME="sexo_per">
                ...
                <TD><SELECT class="campo" NAME="est_civ_per">
                <OPTION VALUE="0">Seleccione...</OPTION>
                ...
                <TD>
                <INPUT TYPE="TEXT" NAME="fec_nac_per" class="campo" VALUE="<? echo $fec_nac_per; ?>" MAXLENGTH="10" SIZE="10" id="fecha" onClick="popUpCalendar(this, datos.fecha, 'dd-mm-yyyy');" READONLY> 
                <IMG SRC="../images/cal.gif" ALT="Haz Click para Buscar la Fecha" WIDTH="16" HEUGHT="16" BORDER="0">
                <A HREF="#"></A>                </TD>
                </TR>
                ...
                <TD><p><font size="2"><strong>
                  <select class="campo" name="codg_pais_nac_per" id="codg_pais_nac_per" onChange="combo_anidado(this.value)">
                ...
                <TD><p><font size="2"><strong>
                  <select class="campo" name="codg_est_nac_per" id="codg_est_nac_per">
                    <option selected="selected">Seleccione...</option>
                  </select>
                </strong></font> </p>
                  </TD>
                <TD><P ALIGN="RIGHT" class="mini">Nacionalidad:</TD>
                <TD><SELECT class="campo" NAME="naci_per">
                <OPTION VALUE="0">Seleccione...</OPTION>
                ...
                <TD><SELECT class="campo" NAME="codg_tip_trab">
                <OPTION VALUE="0">Seleccione...</OPTION>
                ...
                <TD>
                        ...
                        <TD VALIGN="TOP"><INPUT class="campo" TYPE="RADIO" NAME="activo_per" VALUE="S" <? if ($activo_per == "S") {echo 'CHECKED';}?> ></TD>
                        <TD><P ALIGN="RIGHT" class="campo">No</TD>
                        <TD VALIGN="TOP"><INPUT class="campo" TYPE="RADIO" NAME="activo_per" VALUE="N" <? if ($activo_per == "N") {echo 'CHECKED';}?> ></TD>
                        </TR>
                        </TABLE>                </TD>

                <TD><P ALIGN="RIGHT" class="mini">Fecha de Ingreso:</P></TD>
                <TD><INPUT TYPE="TEXT" NAME="fec_ing_per" class="campo" VALUE="<? echo $fec_ing_per; ?>" MAXLENGTH="10" SIZE="10" id="fecha2" onClick="popUpCalendar(this, datos.fecha2, 'dd-mm-yyyy');" READONLY> 
                <IMG SRC="../images/cal.gif" ALT="Haz Click para Buscar la Fecha" WIDTH="16" HEUGHT="16" BORDER="0">                </TD>
                </TR>
                ...
                <TD><SELECT class="campo" NAME="codg_est_dom_per" id="codg_est_dom_per" onChange="combo_anidado2(this.value)">
                <OPTION VALUE="0">Seleccione...</OPTION>
                ...
                <TD><SELECT class="campo" NAME="codg_mun_dom_per" id="codg_mun_dom_per" onChange="combo_anidado3(this.value, codg_est_dom_per.value)">
                ...
                <TD COLSPAN="6"><INPUT class="campo" TYPE="TEXT" NAME="dirc_per" MAXLENGTH="200" SIZE="130" VALUE="<? echo $dirc_per; ?>"></TD>
                </TR>

                <TR>
                <TD><P ALIGN="RIGHT" class="mini">Tel&eacute;fono:</P></TD>
                <TD><P ALIGN="LEFT" class="campo">(<INPUT class="campo" TYPE="TEXT" NAME="codg_tel" MAXLENGTH="4" SIZE="4" VALUE="<? echo $codg_tel; ?>">)<INPUT class="campo" TYPE="TEXT" NAME="tel" MAXLENGTH="7" SIZE="7" VALUE="<? echo $tel; ?>"></P></TD>
                <TD><P ALIGN="RIGHT" class="mini">Celular:</P></TD>
                <TD><P ALIGN="LEFT" class="campo">(<INPUT class="campo" TYPE="TEXT" NAME="codg_cel" MAXLENGTH="4" SIZE="4" VALUE="<? echo $codg_cel; ?>">)<INPUT class="campo" TYPE="TEXT" NAME="cel" MAXLENGTH="7" SIZE="7" VALUE="<? echo $cel; ?>"></P></TD>
                <TD><P ALIGN="RIGHT" class="mini">E-Mail:</P></TD>
                <TD><INPUT class="campo" TYPE="TEXT" NAME="email_per" MAXLENGTH="50" SIZE="30" VALUE="<? echo $email_per; ?>"></TD>
                </TR>
                ...
                <TD><INPUT TYPE="TEXT" NAME="fec_reg_ivss" class="campo" VALUE="<? echo $fec_reg_ivss; ?>" MAXLENGTH="10" SIZE="10" id="fecha3" onClick="popUpCalendar(this, datos.fecha3, 'dd-mm-yyyy');" READONLY>
                <IMG SRC="../images/cal.gif" ALT="Haz Click para Buscar la Fecha" WIDTH="16" HEUGHT="16" BORDER="0">                </TD>

                <TD><P ALIGN="RIGHT" class="mini">Fecha de Retiro:</P></TD>
                <TD><INPUT TYPE="TEXT" NAME="fec_ret_ivss" class="campo" VALUE="<? echo $fec_ret_ivss; ?>" MAXLENGTH="10" SIZE="10" id="fecha4" onClick="popUpCalendar(this, datos.fecha4, 'dd-mm-yyyy');" READONLY>
                <IMG SRC="../images/cal.gif" ALT="Haz Click para Buscar la Fecha" WIDTH="16" HEUGHT="16" BORDER="0">                </TD>

                <TD WIDTH="105"><P ALIGN="RIGHT" class="mini">Nombre del Patrono:</P></TD>
                <TD WIDTH="150"><INPUT class="campo" TYPE="TEXT" NAME="nomb_pat" MAXLENGTH="100" SIZE="30" VALUE="<? echo $nomb_pat; ?>"></TD>
                </TR>
                ...
                <TD COLSPAN="6"><INPUT class="campo" TYPE="FILE" NAME="foto_per" SIZE="50"></TD>
                </TR>
...
if ($action == "ins")
{
  $consulta = mysql_query("SELECT * FROM bdc_datos_per WHERE codg_per=$codg_per");
...

        {
                ...
                if ($fec_reg_ivss == "") {($fec_reg_ivss = "NULL");} else {($fec_reg_ivss = "$fec_reg_ivss");}
                if ($fec_ret_ivss == "") {($fec_ret_ivss = "NULL");} else {($fec_ret_ivss = "$fec_ret_ivss");}
               ...
               echo $qry;
                ...
                echo '<SCRIPT>alert("Datos Personales Agregados");</SCRIPT>
                      ...
                      <SCRIPT>location = "'.$tab_direccion.'&id_tab=2&direccion=bdc_add_datos_academicos.php";</SCRIPT>';
...
//alert(cod_area); 
	...
	var indice=0; 
	<? 
		$sql_nom_dep = "SELECT * from bdc_municipios"; 
		$rs_nom_dep = mysql_query($sql_nom_dep); 
		if(mysql_num_rows($rs_nom_dep)>0){
			do{
				?> 
...
function combo_anidado3(cod_area, cod_area2){ 
//alert(cod_area); 
	document.datos.codg_parr_dom_per.length=0; 
	document.datos.codg_parr_dom_per.options[0] = new Option("Seleccione...","","defaultSelected","");								 	var indice=0; 
	<? 
		$sql_nom_dep = "SELECT * from bdc_parroquias"; 
		$rs_nom_dep = mysql_query($sql_nom_dep); 
		if(mysql_num_rows($rs_nom_dep)>0){
			do{
				?>
