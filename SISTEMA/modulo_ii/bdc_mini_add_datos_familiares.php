...
<HTML>
<HEAD>
<TITLE>Agregar Datos Familiares</TITLE>
...
<BR>
<H2>Agregar Datos Familiares</H2>
<?
...
<FORM METHOD="post" NAME="datos" action="bdc_mini_add_datos_familiares.php">
         ...
         <TABLE BORDER="0" ALIGN="CENTER">
                ...
                <TD>
                <INPUT TYPE="TEXT" NAME="fec_nac_carga_fam" class="campo" VALUE="<? echo $fec_nac_carga_fam; ?>" MAXLENGTH="10" SIZE="10" id="fecha" onClick="popUpCalendar(this, datos.fecha, 'dd-mm-yyyy');" READONLY> 
        ...
        <CENTER><INPUT class="mini" TYPE="SUBMIT" VALUE="Agregar" onClick="ingresar()" title="Haga click para almacenar los datos">&nbsp;<INPUT class="mini" TYPE="BUTTON" VALUE="Cerrar Ventara" onClick="cerrar()" title="Haga click para cerrar la ventana actual" ></CENTER>
