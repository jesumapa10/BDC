...
<title>Agregar Archivos Digitales</title>
</HEAD>
...
<FORM METHOD="POST" ENCTYPE="multipart/form-data" NAME="datos" ACTION="bdc_mini_add_archivos_digitales.php">
        ...
        <TABLE BORDER="0" ALIGN="CENTER">
                ...
                <TD WIDTH="450"><SELECT class="campo" NAME="codg_tip_documento" title="Seleccione de la lista el tipo de documento que desea registrar">
         ...
         ?>
                ...
                <TD>
                <INPUT TYPE="TEXT" NAME="fec_arc_dig" class="campo" VALUE="<? echo $fec_arc_dig; ?>" MAXLENGTH="10" SIZE="10" id="fecha" onClick="popUpCalendar(this, datos.fecha, 'dd-mm-yyyy');" READONLY title="Seleccione con ayuda del calendario la fecha en que esta registrando el archivo"> 
            <IMG onClick="popUpCalendar(this, datos.fecha, 'dd-mm-yyyy');" SRC="../images/cal.gif" ALT="Haz Click para Buscar la Fecha" WIDTH="16" HEUGHT="16" BORDER="0">
                ...
                <TD COLSPAN="6"><INPUT class="campo" TYPE="FILE" NAME="imgn_arc_dig" SIZE="50" title="Haga click para buscar el archivo que desea registrar"></TD>
                </TR>
