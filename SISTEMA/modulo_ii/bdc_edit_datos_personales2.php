...
<FORM METHOD="post" ENCTYPE="multipart/form-data" NAME="datos" action="">
        <TABLE BORDER="0" ALIGN="CENTER">
                ...
                <TR>
                  ...
                  <INPUT class="campo" TYPE="TEXT" NAME="codg_per_new" SIZE="8" MAXLENGTH="8" VALUE="<? echo $codg_per; ?>" title="Introduzca el número de cédula del personal">
                  </P></TD>
                ...
                <TR>
                  ...
                  <TD><SELECT class="campo" NAME="codg_pais_nac_per" title ="Seleccione de la lista el país donde nació el personal" id="codg_pais_nac_per" onChange="cambo_anidado(this.value)">                      <OPTION value="0">Seleccione...</OPTION>
                ...
                <TD><SELECT class="campo"name="codg_est_nac_per" id="codg_est_nac_per" title="Seleccione de la lista el estado en que nació el personal">
                ...
                <TD>
                       <TABLE>
                        ...
                        <TD VALIGN="TOP"><INPUT title="El seleccione esta opción si el personal se encuentra activo" class="campo" TYPE="RADIO" NAME="activo_per" VALUE="S" <? if ($activo_per == "S") {echo 'CHECKED';}?> ></TD>
                        <TD><P ALIGN="RIGHT" class="campo">No</TD>
                        <TD VALIGN="TOP"><INPUT class="campo" title="El seleccione esta opción si el personal NO se encuentra activo" TYPE="RADIO" NAME="activo_per" VALUE="N" <? if ($activo_per == "N") {echo 'CHECKED';}?> ></TD>
                        </TR>
                  </TABLE>                </TD>
             <TD><P ALIGN="RIGHT" class="mini">Fecha de Ingreso:</P></TD>
                ...
                <TD COLSPAN="6"><INPUT class="campo" TYPE="TEXT" NAME="dirc_per" MAXLENGHT="200" SIZE="130" VALUE="<? echo $dirc_per; ?>" title="Escriba la dirección de domicilio del personal"></TD>
                </TR>
                ...
                <TD><P ALIGN="LEFT" class="campo">(<INPUT class="campo" TYPE="TEXT" NAME="codg_tel" MAXLENGHT="4" SIZE="1" VALUE="<? echo $codg_tel; ?>" title="Introduzca el código de área del teléfono del personal">
                )<INPUT class="campo" TYPE="TEXT" NAME="tel" MAXLENGHT="7" SIZE="7" VALUE="<? echo $tel; ?>" title="Introduzca el número de teléfono del personal"></P></TD>
                <TD><P ALIGN="RIGHT" class="mini">Celular:</P></TD>

                <TD><P ALIGN="LEFT" class="campo">(<INPUT class="campo" TYPE="TEXT" NAME="codg_cel" MAXLENGHT="4" SIZE="1" VALUE="<? echo $codg_cel; ?>" title="Introduzca el código de la operadora del celular del personal">
                )<INPUT class="campo" TYPE="TEXT" NAME="cel" MAXLENGHT="7" SIZE="7" VALUE="<? echo $cel; ?>" title="Introduzca el número de celular del personal"></P></TD>
                <TD><P ALIGN="RIGHT" class="mini">E-Mail:</P></TD>
                <TD><INPUT class="campo" TYPE="TEXT" NAME="email_per" MAXLENGHT="50" SIZE="30" VALUE="<? echo $email_per ?>" title="Introduzca el correo electrónico del personal"></TD>
                </TR>
...
<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
  ...
  frmvalidator.addValidation("codg_per_new","req","Ingrese la Cédula de la Persona");
  frmvalidator.addValidation("codg_per_new","num","La Cédula de la Persona sólo acepta caracteres numéricos");
  frmvalidator.addValidation("codg_per_new","minlen=6","El Mínimo de Caracteres para la Cédula es 6");
  ...
  frmvalidator.addValidation("cel","num","El numero celular de la Persona sólo acepta caracteres numéricos");
