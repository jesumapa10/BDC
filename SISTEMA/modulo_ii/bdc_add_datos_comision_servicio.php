...
function siguiente()
        {
        location = "bdc_add_archivos.php?codg_per=<? echo $codg_per; ?>";
        }
...
<SCRIPT>do_tabs("Comisiones de Servicio", "")</SCRIPT>
        ...
        <FORM METHOD="post" NAME="datos" action="bdc_add_datos_comision_servicio.php">
                ...
                <TD><SELECT class="campo" NAME="codg_plantel_desde">
                <OPTION value="0">Seleccione...</OPTION>
                 <?
             ...
             ?>
                ...
                <TD><SELECT class="campo" NAME="codg_plantel_insti_hacia_com_serv">
                <OPTION value="0">Seleccione...</OPTION>
                <?
               ...
               ?>
                ...
                <TD><P class="campo"><TEXTAREA class="campo" ROWS="5" COLS="100" NAME="func_desemp_com_serv" MAXLENGTH="250" SIZE="1" VALUE="<? echo $func_desemp_com_serv; ?>" ><? echo $func_desemp_com_serv; ?></TEXTAREA></P></TD>
                </TR>

                <TR>
                  <TD><P ALIGN="RIGHT" class="mini">Fecha de Inicio:</P></TD>
                  <TD><INPUT TYPE="TEXT" NAME="fec_inicio_com_serv" class="campo" VALUE="<? echo $fec_inicio_com_serv; ?>" MAXLENGTH="10" SIZE="10" READONLY>
                  <A HREF="#"><IMG SRC="../images/cal.gif" ALT="Haz Click para Buscar la Fecha" WIDTH="16" HEUGHT="16" BORDER="0" onClick="c1.popup('fec_inicio_com_serv');"></A>
                  </TD>
                </TR>

                <TR>
                  <TD><P ALIGN="RIGHT" class="mini">Fecha Fin:</P></TD>
                  <TD><INPUT TYPE="TEXT" NAME="fec_fin_com_serv" class="campo" VALUE="<? echo $fec_fin_com_serv; ?>" MAXLENGTH="10" SIZE="10" READONLY>
                  <A HREF="#"><IMG SRC="../images/cal.gif" ALT="Haz Click para Buscar la Fecha" WIDTH="16" HEUGHT="16" BORDER="0" onClick="c1.popup('fec_fin_com_serv');"></A>
                  </TD>
                </TR>
...
if ($action == "ins")
{
   ...
   $fec_fin_com_serv = substr($fec_fin_com_serv,6,4)."-".substr($fec_fin_com_serv,3,2)."-".substr($fec_fin_com_serv,0,2);
        ...
        $qry = "INSERT INTO bdc_com_serv VALUES ( $codg_per, $codg_plantel_desde,
                         ...
                         '$func_desemp_com_serv','$fec_inicio_com_serv', '$fec_fin_com_serv')";
