<?php include("../style/colores_fonts.php"); ?>
<SCRIPT>
// general
var path                        = "/intranet"
// tabs
var tab_font                    = "<?php echo $tabfont1; ?>"
var tab_width                   = ""
var up_arrow                    = "^ "
var show_parent                 = true
var show_sibs                   = false
var tab_color                   = "<?php echo $tabcolor1; ?>"
var tab_font_color              = "<?php echo $tabcolor2; ?>"
var open_tab_color              = "<?php echo $tabcolor3; ?>"
var open_tab_font_color         = "<?php echo $tabcolor4; ?>"

// buttons
var button_font                 = "<?php echo $tabfont1; ?>"
var button_width                = ""
...
// links
var splitter                    = ":"
var link_font                   = "<?php echo $tabfont1; ?>"
...
links = new Array
(
 new link(path+"/modulo_ii/bdc_edit_datos_personales.php?codg_per=<?echo $codg_per; ?>",                "Datos Personales",        ""),
 new link(path+"/modulo_ii/bdc_edit_datos_academicos.php?codg_per=<?echo $codg_per; ?>",                "Datos Académicos",        ""),
 new link(path+"/modulo_ii/bdc_edit_datos_laborales.php?codg_per=<?echo $codg_per; ?>",                 "Datos Laborales",         ""),
 new link(path+"/modulo_ii/bdc_edit_traslados.php?codg_per=<?echo $codg_per; ?>",                       "Traslados",               ""),
 new link(path+"/modulo_ii/bdc_edit_datos_gremiales.php?codg_per=<?echo $codg_per; ?>",                 "Datos Gremiales",         ""),
 new link(path+"/modulo_ii/bdc_edit_datos_familiares.php?codg_per=<?echo $codg_per; ?>",                "Datos Familiares",        ""),
 new link(path+"/modulo_ii/bdc_edit_datos_permisos.php?codg_per=<?echo $codg_per; ?>",                  "Permisos",        ""),
 new link(path+"/modulo_ii/bdc_edit_datos_comision_servicio.php?codg_per=<?echo $codg_per; ?>",         "Comisiones de Servicio",        ""),
 new link(path+"/modulo_ii/bdc_edit_archivos_digitales.php?codg_per=<?echo $codg_per; ?>",              "Archivo",                 "")
)
 ...
 for( num=0; num<links_length; num++)
 {
  if(links[num].name == level || links[num].parent == level)
  {
   ...
   if(links[num].parent == level)
   {
    ...
    document.write   ("<font size=2>&nbsp;&nbsp;</font>")
    document.write   ("<a href='" + links[num].path + "' title='" + links[num].name + "'>")
    document.write   ("<font face='" + tab_font + "' size=<?php echo $tabfontsize1; ?> color='" + fntcolor + "'>" + links[num].name + "</font></a>")
    document.write   ("<font size=2>&nbsp;&nbsp;</font>")
    document.writeln ("</nobr></td>")
    document.writeln ("<td width=2></td>")
   }
