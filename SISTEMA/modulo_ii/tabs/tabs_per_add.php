...
links = new Array
(
 new link(path+"/modulo_ii/bdc_add_datos_academicos.php?codg_per=<?echo $codg_per; ?>",               "Datos Académicos",        ""),
 new link(path+"/modulo_ii/bdc_add_datos_laborales.php?codg_per=<?echo $codg_per; ?>",                "Datos Laborales",        ""),
 new link(path+"/modulo_ii/bdc_add_traslados.php?codg_per=<?echo $codg_per; ?>",                      "Traslados",                ""),
 new link(path+"/modulo_ii/bdc_add_datos_gremiales.php?codg_per=<?echo $codg_per; ?>",                "Datos Gremiales",        ""),
 new link(path+"/modulo_ii/bdc_add_datos_familiares.php?codg_per=<?echo $codg_per; ?>",               "Datos Familiares",        ""),
 new link(path+"/modulo_ii/bdc_add_datos_permisos.php?codg_per=<?echo $codg_per; ?>",                 "Permisos",        ""),
 new link(path+"/modulo_ii/bdc_add_datos_comision_servicio.php?codg_per=<?echo $codg_per; ?>",       "Comisiones de Servicio",        ""),
 new link(path+"/modulo_ii/bdc_add_archivos.php?codg_per=<?echo $codg_per; ?>",                       "Archivo",        "")
 )
