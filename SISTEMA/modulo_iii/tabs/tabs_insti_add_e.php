...
var show_sibs                                = false
var tab_color                                = "#990000"
var tab_font_color                        = "#FFFFFF"
var open_tab_color                        = "#FF6A6A"
...
links = new Array
(
 new link(path+"/modulo_iii/bdc_edit_datos_personal_labora.php?codg_insti=<? echo $codg_insti; ?>",                "Personal de la Institución",        ""),
 new link(path+"/modulo_iii/bdc_edit_datos_instituciones.php?codg_insti=<? echo $codg_insti; ?>",                "Datos Institución",        ""),
 new link(path+"/modulo_iii/bdc_edit_datos_plantel.php?codg_insti=<? echo $codg_insti; ?>",                "Datos Plantel",        "")
)
