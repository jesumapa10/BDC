...
links = new Array
(
new link(path+"/modulo_iii/bdc_datos_personal_labora.php?codg_insti=<? echo $codg_insti; ?>",                "Personal de la Institución",        ""),
 new link(path+"/modulo_iii/bdc_datos_instituciones.php?codg_insti=<? echo $codg_insti; ?>",                "Datos Institución",        ""),
 new link(path+"/modulo_iii/bdc_datos_plantel.php?codg_insti=<? echo $codg_insti; ?>",                "Datos Plantel",        "")
)
