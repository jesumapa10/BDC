...
links = new Array
(
 new link(path+"/modulo_admin/bdc_permisos_user_rrhh.php?codg_usr=<? echo $codg_usr ?>",                "R.R.H.H.",        ""),
 new link(path+"/modulo_admin/bdc_permisos_user_adminis.php?codg_usr=<? echo $codg_usr ?>",                 "Administración",        ""),
 new link(path+"/modulo_admin/bdc_permisos_user_sedz.php?codg_usr=<? echo $codg_usr ?>",                "Sedes Zonales",        ""),
 new link(path+"/modulo_admin/bdc_permisos_user_acad.php?codg_usr=<? echo $codg_usr ?>",                "Académico",        ""),
 new link(path+"/modulo_admin/bdc_permisos_user_util.php?codg_usr=<? echo $codg_usr ?>",                "Utilidades",        "")
)
